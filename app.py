...
# Fungsi geocoding alamat (via Nominatim)
...
# Kalau lat/lon berhasil ditemukan, jalankan proses
if lat and lon:
    user_loc = (lat, lon)
    ...
    st.info("Silakan masukkan alamat atau buka link dengan lokasi seperti `?lat=...&lon=...` di URL.")
